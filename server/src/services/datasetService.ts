...
export class DatasetService {
  ...
  async updateColumnMetadata(
    ...
    // In the simplified model, column metadata is auto-generated from system tables
    // We don't persist custom metadata for now
    // This method is kept for API compatibility but does nothing
    console.warn('updateColumnMetadata called but column metadata is auto-generated in the new model')
  }
